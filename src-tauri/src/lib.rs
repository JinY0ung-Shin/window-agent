...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::hub_login,
            commands::hub_logout,
            commands::hub_get_auth_status,
            commands::hub_get_me,
            commands::hub_update_me,
            commands::hub_share_agent,
            commands::hub_share_skills,
            commands::hub_share_notes,
            commands::hub_list_agents,
            commands::hub_list_skills,
            commands::hub_list_notes,
            commands::hub_delete_agent,
            commands::hub_delete_skill,
            commands::hub_delete_note,
            ...
            commands::get_browser_no_proxy,
            commands::set_browser_no_proxy,
            commands::detect_system_proxy,
            commands::detect_system_no_proxy,
            ...
            commands::relay_clear_my_chat_messages,
            commands::relay_clear_all_my_chat_messages,
