...
export const AGENT_TEMPLATES: AgentTemplate[] = [
  {
    ...
    personaFiles: {
      ko: {
        ...
        agents: "# 팀 구성원\n\n다른 에이전트와 협업하여 종합적인 코드 품질 관리를 수행합니다.",
      },
      en: {
        ...
        agents: "# Team Members\n\nCollaborate with other agents for comprehensive code quality management.",
      },
    },
  },
  {
  ...
  },
  {
    ...
    personaFiles: {
      ko: {
        ...
        agents: "# 팀 구성원\n\n다른 에이전트와 협업하여 데이터 기반 워크플로우를 지원합니다.",
      },
      en: {
        ...
        agents: "# Team Members\n\nCollaborate with other agents to support data-driven workflows.",
      },
    },
  },
  {
    ...
    personaFiles: {
      ko: {
        ...
        agents: "# 팀 구성원\n\n전문 에이전트가 필요한 경우 적절한 팀원에게 연결합니다.",
      },
      en: {
        ...
        agents: "# Team Members\n\nConnect to specialized agents when expert help is needed.",
      },
    },
  },
];
