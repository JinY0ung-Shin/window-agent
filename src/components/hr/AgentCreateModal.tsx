...
import type { AiBackendType, CreateAgentRequest } from "../../services/types";
...
export function AgentCreateModal() {
  const { showCreateModal, departments, closeCreateModal, hireAgent } = useHrStore();
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex justify-end gap-2 pt-1">
          ...
          <Button type="submit">채용하기</Button>
        </div>
      </form>
    </ModalShell>
  );
