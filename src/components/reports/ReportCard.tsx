...
export function ReportCard({ report }: ReportCardProps) {
  ...
  return (
    <div
      ...
      className="bg-surface-800 border border-white/[0.06] rounded-2xl p-4 cursor-pointer hover:bg-surface-700/60 transition-all"
    >
      <div className="flex items-start justify-between gap-2 mb-3">
        ...
        <span
          className={`inline-flex items-center px-2 py-0.5 rounded-full text-[11px] font-medium shrink-0 ${badge.className}`}
        >
          {badge.label}
        </span>
      </div>
