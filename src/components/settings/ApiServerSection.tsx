...
export interface ApiServerSectionValues {
  apiKey: string;
  clearApiKey: boolean;
  baseUrl: string;
  modelName: string;
...
export interface ApiServerSectionRef {
  getValues: () => ApiServerSectionValues;
}
...
const ApiServerSection = forwardRef<ApiServerSectionRef, Props>(
  function ApiServerSection({ isOpen }, ref) {
