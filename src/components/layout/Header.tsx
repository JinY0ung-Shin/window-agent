export function Header() {
  return (
    <header className="h-14 flex items-center justify-between px-5 border-b border-surface-700 bg-surface-800/80 backdrop-blur-md">
      ...
      <div className="flex items-center gap-3">
        <button className="relative w-8 h-8 rounded-lg bg-surface-700 hover:bg-surface-600 flex items-center justify-center transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-500/70">
        ...
        <div className="flex items-center gap-2 pl-3 border-l border-surface-700">
          <div className="w-8 h-8 rounded-full bg-gradient-to-br from-accent-500/30 to-accent-600/20 flex items-center justify-center text-base shadow-md">
            👤
          </div>
          <div>
